...
> Integrity timeline: v0.2.1 was created while repository release immutability
> was disabled. After the policy was enabled and the release note was updated,
> GitHub's API reported `immutable: true` and `gh release verify v0.2.1`
> verified the tag and attached receipt. No destructive mutation probe was run.
